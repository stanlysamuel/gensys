...
def move1(x, y1, y2, z, pc1, pc2, pc3, x_, y1_, y2_, z_, pc1_, pc2_, pc3_):
    return Or(  # Single transitions
                ...
                # Making it complete
                And(Not(pc1<=0, pc1>=3), pc1_ == pc1, x_ == x, y1_ == y1, y2_ == y2, z_ == z, pc2_ == pc2, pc3_ == pc3)
                # Atomic Sections
...
def move2(x, y1, y2, z, pc1, pc2, pc3, x_, y1_, y2_, z_, pc1_, pc2_, pc3_):
    return Or(  # Single transitions
                ...
                # Making it complete
                And(Not(pc2<=0, pc2>=3), pc2_ == pc2, x_ == x, y1_ == y1, y2_ == y2, z_ == z, pc1_ == pc1, pc3_ == pc3)
                # Atomic Sections
...
def move3(x, y1, y2, z, pc1, pc2, pc3, x_, y1_, y2_, z_, pc1_, pc2_, pc3_):
    return Or(  # Single transitions
                ...
                # Making it complete
                And(Not(pc3<=0, pc3>=4), pc3_ == pc3, x_ == x, y1_ == y1, y2_ == y2, z_ == z, pc2_ == pc2, pc1_ == pc1)
                # Atomic Sections
