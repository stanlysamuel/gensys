...
if spec_type == "simple":
    ...
    if spec_type == "product-buchi":
        ...
        def automaton(q, q_, x1,y1,x2,y2):
            return Or(
                    And(q == 0, q_==1, Not(And(Implies(And(x1>=x2, y1>=y2), (x1-x2) + (y1-y2)<=2), Implies(And(x1>=x2, y1<y2), (x1-x2) + (y2-y1)<=2), Implies(And(x1<x2, y1>=y2), (x2-x1) + (y1-y2)<=2), Implies(And(x1<x2, y1<y2), (x2-x1) + (y2-y1)<=2)))),
                    And(q == 0, q_==0, And(Implies(And(x1>=x2, y1>=y2), (x1-x2) + (y1-y2)<=2), Implies(And(x1>=x2, y1<y2), (x1-x2) + (y2-y1)<=2), Implies(And(x1<x2, y1>=y2), (x2-x1) + (y1-y2)<=2), Implies(And(x1<x2, y1<y2), (x2-x1) + (y2-y1)<=2))),
                    And(q == 1, q_==1),
                    )
        ...
        if spec_type == "product-co-buchi":
            ...
            if spec_type == "otf":
                ...
                def sigma(x1,y1,x2,y2):
                    return [And(Implies(And(x1>=x2, y1>=y2), (x1-x2) + (y1-y2)<=2), Implies(And(x1>=x2, y1<y2), (x1-x2) + (y2-y1)<=2), Implies(And(x1<x2, y1>=y2), (x2-x1) + (y1-y2)<=2), Implies(And(x1<x2, y1<y2), (x2-x1) + (y2-y1)<=2)), Not(And(Implies(And(x1>=x2, y1>=y2), (x1-x2) + (y1-y2)<=2), Implies(And(x1>=x2, y1<y2), (x1-x2) + (y2-y1)<=2), Implies(And(x1<x2, y1>=y2), (x2-x1) + (y1-y2)<=2), Implies(And(x1<x2, y1<y2), (x2-x1) + (y2-y1)<=2)))]
