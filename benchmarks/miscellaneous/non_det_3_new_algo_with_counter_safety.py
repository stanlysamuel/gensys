...
def counter_constraints(state_, c, c_):
    return  And(
            Implies(state_==2, c_ == c + 1),
            Implies(state_!=2, c_ == c)
    )


# def counter_constraints(state_, c, c_):
#     return  And(
#             Implies(And(state_==2, c == 1), c == c_),
#             Implies(And(state_==2, c <= 0), c_ == c + 1),
#             Implies(state_!=2, c == c_)
#     )

# def counter_constraints(state_, c, c_):
#     return  Or(
#             And(state_==2, c == 1, c == c_),
#             And(state_==2, c <= 0, c_ == c + 1),
#             And(state_!=2, c == c_)
#     )

# def counter_constraints(state_, c, c_):
#     return  Or(
#             And(state_==2, c_ == -1, c == c_),
#             And(state_==2, c_ >= 0, c == c_ - 1),
#             And(state_!=2, c == c_)
#     )
