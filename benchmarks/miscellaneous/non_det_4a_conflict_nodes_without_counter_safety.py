...
# This example proves the presence of conflict nodes.
# Product game realizable with conflict nodes and Original game is unrealizable.
...
def automaton(s, s_, x):
    return Or(
            And(s == 1, s_==2),
            And(s == 1, s_==5),
            And(s == 2, s_==1, Not(x==3)),
            And(s == 2, s_==3, x==3),
            And(s == 5, s_==1, Not(x==1)),
            And(s == 5, s_==6, x==1),
            And(s == 3, s_==4),
            And(s == 3, s_==2),
            And(s == 6, s_==7),
            And(s == 6, s_==5),
            And(s == 4, s_==1, Not(x==3)),
            And(s == 4, s_==6, x==3),
            And(s == 7, s_==1, Not(x==1)),
            And(s == 7, s_==3, x==1)
            )
...
# 3. Define Guarantee
def guarantee(s, x):
    return And(s>=2, s<=7, x>=1, x<=3)
    # return And(s>=2, s<=7, x>=1, x<=3, Not(And(s==3, x==2)))
