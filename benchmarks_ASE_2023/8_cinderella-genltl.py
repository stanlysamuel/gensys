...
# Cinderella-Stepmother game of 5 buckets with bucket size of C = 1.4. Here, the controller (protagonist) is Cinderella and it aims to win the game by satisfying a general LTL specification. 
# Specification: General LTL formula 'GF p0 | (GF p2 & !GF p0 & !GF p1)'
                        # where
...
if spec_type == "simple":
    ...
    if spec_type == "product-buchi":
        ...
        # Not applicable Buchi automaton is not deterministic.
        # Use exit code 5 to denote N/A.
        sys.exit(5)
